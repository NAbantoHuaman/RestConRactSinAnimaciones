  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className={`flex items-center space-x-1 sm:space-x-2 px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg shadow-sm ${
          isScrolled
        ...
        <div className="absolute top-full right-0 mt-2 w-44 sm:w-48 bg-white border border-neutral-200 rounded-lg shadow-lg z-50 overflow-hidden">
          {languages.map((languageOption) => (
            <button
              ...
              className={`w-full flex items-center space-x-2 sm:space-x-3 px-3 sm:px-4 py-2.5 sm:py-3 text-left ${
