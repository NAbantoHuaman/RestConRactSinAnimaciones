        ...
        <div className="text-center mb-6 sm:mb-12">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 justify-center mt-4 sm:mt-8">
            <button
              ...
              className="group relative overflow-hidden bg-gradient-to-r from-blue-500 to-blue-600 text-white px-4 py-2 sm:px-8 sm:py-4 rounded-2xl font-semibold shadow-lg"
            >
            ...
            <Link
              to="/reservation-form"
              className="group relative overflow-hidden bg-gradient-to-r from-amber-500 to-orange-500 text-white px-4 py-2 sm:px-8 sm:py-4 rounded-2xl font-semibold shadow-lg"
            >
  ...
  {t('reservations.createFirstReservation')}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {sortedReservations.map((reservation, index) => (
                <div
                  key={reservation.id}
                  className="group relative bg-white rounded-2xl shadow-lg border border-neutral-200 p-4 sm:p-6"
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-amber-50/30 to-orange-50/20 rounded-2xl"></div>
                  
                  <div className="relative z-10">
                    <div className="flex items-start space-x-3 mb-3">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-amber-500 to-orange-500 rounded-xl flex items-center justify-center text-white font-bold text-lg sm:text-xl shadow-lg flex-shrink-0">
                        {reservation.tableNumber}
                      </div>
                      <div className="flex-1 min-w-0">
                        <h3 className="text-base sm:text-xl font-bold text-neutral-900 truncate">
                      ...
                      <button
                        ...
                        className="group/btn relative w-8 h-8 sm:w-10 sm:h-10 bg-red-50 rounded-lg flex items-center justify-center border border-red-200 flex-shrink-0"
                      >
                    ...
                    <div className="mt-3 flex items-center justify-between">
                      <div className="flex gap-2">
                        <button
                          ...
                          className="px-3 py-2 border border-amber-300 text-amber-700 rounded-lg text-xs sm:text-sm"
                        >
                          {language === 'en' ? 'View receipt' : 'Ver boleta'}
                        </button>
                        <button
                          onClick={() => toggleQRFor(reservation.id)}
                          className="px-3 py-2 border border-neutral-300 text-neutral-700 rounded-lg text-xs sm:text-sm"
                        >
